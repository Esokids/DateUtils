...
describe('Custome Date ISO to Full Date', () => {
  it('en', () => {
    let date = '2020-09-21T01:13:45.906Z';
    let valid = 'September 21st, 2020';
    expect(valid).to.equal(dateToHuman(date, 'en', 'PPP'));
  });

  it('th', () => {
    let date = '2020-09-21T01:13:45.906Z';
    let valid = '21 กันยายน 2563';
    expect(valid).to.equal(dateToHuman(date, 'th', 'PPP'));
  });
});
